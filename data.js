...
var _data = {
    ...
    positions: [
        ...
        },
        {
            ...
            'Build a class diagram and dependency diagram. ' +
            'Held meetings with the team. ' +
            'Write code using Java. Making JSP. Using Spring MVC, Core. Coding on JavaScript, jQuery. Using Google Apps API.' +
            ...
            'Held meetings with the team. ' +
            'Develop Tomcat based Java solutions. Spring MVC, Spring Core, Spring Security. Java, Servlets, JavaScript, jQuery. Google Apps API.' +
            'Write and maintain code documentation.'
        },{
            companyId: 2,
            role: 'Java Developer',
            ...
            'Database development: DDL. Database Design/Modeling (Power Designer). Building UI (front-end with DML).'
        }
    ],
    companies: [{
        companyId: 0,
